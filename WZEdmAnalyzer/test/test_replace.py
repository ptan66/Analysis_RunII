...
process.MyPFCHSSecondaryVertexTagInfos = process.pfSecondaryVertexTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyPFCHSImpactParameterTagInfos") # use the above IP TagInfos as input
)

process.MyPFCHSInclusiveSecondaryVertexFinderTagInfos = process.pfInclusiveSecondaryVertexFinderTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyPFCHSImpactParameterTagInfos") # use the above IP TagInfos as input
)
...
process.MyPFCHSCombinedSecondaryVertexV2BJetTags = process.pfCombinedInclusiveSecondaryVertexV2BJetTags.clone(
    tagInfos = cms.VInputTag(cms.InputTag("MyPFCHSImpactParameterTagInfos"), 
                           cms.InputTag("MyPFCHSInclusiveSecondaryVertexFinderTagInfos")			
	)
)
...
process.MyPFCHSSoftPFElectronsTagInfos= process.softPFElectronsTagInfos.clone(

    jets = cms.InputTag("ak4PFJetsCHS") # use ak4PFJetsCHS stored in AOD as input
)

process.MyPFCHSSoftPFMuonsTagInfos = process.softPFMuonsTagInfos.clone(
    jets = cms.InputTag("ak4PFJetsCHS") # use ak4PFJetsCHS stored in AOD as input
)

process.MyPFCHSCombinedMVAV2BJetTags = process.combinedMVAV2BJetTags.clone(
    tagInfos = cms.VInputTag( cms.InputTag("MyPFCHSImpactParameterTagInfos"),
                               cms.InputTag("MyPFCHSSecondaryVertexTagInfos"),
                               cms.InputTag("MyPFCHSInclusiveSecondaryVertexFinderTagInfos"),
                               cms.InputTag("MyPFCHSSoftPFMuonsTagInfos"),
                               cms.InputTag("MyPFCHSSoftPFElectronsTagInfos")
                               )
)
...
process.MyPFSecondaryVertexTagInfos = process.pfSecondaryVertexTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyPFImpactParameterTagInfos") # use the above IP TagInfos as input
)

process.MyPFInclusiveSecondaryVertexFinderTagInfos = process.pfInclusiveSecondaryVertexFinderTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyPFImpactParameterTagInfos") # use the above IP TagInfos as input
)
...
process.MyPFCombinedSecondaryVertexV2BJetTags = process.pfCombinedInclusiveSecondaryVertexV2BJetTags.clone(
    tagInfos = cms.VInputTag(cms.InputTag("MyPFImpactParameterTagInfos"), 
                           cms.InputTag("MyPFInclusiveSecondaryVertexFinderTagInfos")			
	)
)
...
process.MyPFSoftPFElectronsTagInfos= process.softPFElectronsTagInfos.clone(

    jets = cms.InputTag("ak4PFJets") # use ak4PFJetsCHS stored in AOD as input
)

process.MyPFSoftPFMuonsTagInfos = process.softPFMuonsTagInfos.clone(
    jets = cms.InputTag("ak4PFJets") # use ak4PFJetsCHS stored in AOD as input
)

process.MyPFCombinedMVAV2BJetTags = process.combinedMVAV2BJetTags.clone(
    tagInfos = cms.VInputTag( cms.InputTag("MyPFImpactParameterTagInfos"),
                               cms.InputTag("MyPFSecondaryVertexTagInfos"),
                               cms.InputTag("MyPFInclusiveSecondaryVertexFinderTagInfos"),
                               cms.InputTag("MyPFSoftPFMuonsTagInfos"),
                               cms.InputTag("MyPFSoftPFElectronsTagInfos")
                               )
)
...
process.myPFBTaggers = cms.Sequence(
  ...
  (
     ...
     (  process.MyPFInclusiveSecondaryVertexFinderTagInfos *
        process.MyPFCombinedSecondaryVertexV2BJetTags
        ) 
#+ 
#     (  process.MyPFSecondaryVertexTagInfos * 
#        process.MyPFInclusiveSecondaryVertexFinderTagInfos *
#        process.MyPFSoftPFMuonsTagInfos *
#        process.MyPFSoftPFElectronsTagInfos *
#        process.MyPFCombinedMVAV2BJetTags
#        )
     )
)
...
process.MyAK5PFImpactParameterTagInfos = process.pfImpactParameterTagInfos.clone(
    jets = cms.InputTag("ak5PFJets") # use ak4AK5PFJetsCHS stored in AOD as input
)

process.MyAK5PFSecondaryVertexTagInfos = process.pfSecondaryVertexTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyAK5PFImpactParameterTagInfos") # use the above IP TagInfos as input
)

process.MyAK5PFInclusiveSecondaryVertexFinderTagInfos = process.pfInclusiveSecondaryVertexFinderTagInfos.clone(
    trackIPTagInfos = cms.InputTag("MyAK5PFImpactParameterTagInfos") # use the above IP TagInfos as input
)
...
process.MyAK5PFCombinedSecondaryVertexV2BJetTags = process.pfCombinedInclusiveSecondaryVertexV2BJetTags.clone(
    tagInfos = cms.VInputTag(cms.InputTag("MyAK5PFImpactParameterTagInfos"), 
                             cms.InputTag("MyAK5PFInclusiveSecondaryVertexFinderTagInfos")			
	)
)
...
process.MyAK5PFSoftPFElectronsTagInfos= process.softPFElectronsTagInfos.clone(

    jets = cms.InputTag("ak5PFJets") # use ak4AK5PFJetsCHS stored in AOD as input
)

process.MyAK5PFSoftPFMuonsTagInfos = process.softPFMuonsTagInfos.clone(
    jets = cms.InputTag("ak5PFJets") # use ak4AK5PFJetsCHS stored in AOD as input
)

process.MyAK5PFCombinedMVAV2BJetTags = process.combinedMVAV2BJetTags.clone(
    tagInfos = cms.VInputTag( cms.InputTag("MyAK5PFImpactParameterTagInfos"),
                               cms.InputTag("MyAK5PFSecondaryVertexTagInfos"),
                               cms.InputTag("MyAK5PFInclusiveSecondaryVertexFinderTagInfos"),
                               cms.InputTag("MyAK5PFSoftPFMuonsTagInfos"),
                               cms.InputTag("MyAK5PFSoftPFElectronsTagInfos")
                               )
)
...
#        process.MyAK5PFInclusiveSecondaryVertexFinderTagInfos *
#        process.MyAK5PFSoftPFMuonsTagInfos *
#        process.MyAK5PFSoftPFElectronsTagInfos *
#        process.MyAK5PFCombinedMVAV2BJetTags
#        )
     )
)
